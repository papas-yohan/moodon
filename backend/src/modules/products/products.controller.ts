...
export class ProductsController {
  ...
  async uploadMultipleImages(
    ...
    return this.productsService.uploadMultipleImages(productId, files, uploadDto);
  }
  ...
  @ApiResponse({ status: 204, description: '이미지가 성공적으로 삭제되었습니다.' })
  @ApiResponse({ status: 404, description: '상품 또는 이미지를 찾을 수 없습니다.' })
  async deleteImage(
    @Param('id') productId: string,
